...
if __name__ == "__main__":
    ...
    titles = 'initial data', 'KMeans++ clustering', 'data after rotation', 'KMeans++clustering after rotation',\
             'data with variance', 'KMeans++clustering with variance', 'data with different size', 'KMeans++clsutering on different size'
    ...
    for i, (x, y, title) in enumerate(zip(data_list, y_list, titles), start=1):
        ...
        print('AR: ', adjusted_rand_score(y, y_pred))
    ...
    # plt.suptitle('impact on KMeans', fontsize=18)
    plt.show()
